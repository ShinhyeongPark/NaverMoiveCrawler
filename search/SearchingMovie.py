        ...
        while True:
            for x in range(1, int(cnt) // 10 + 1):
                ...
                for i in range(len(reple)):
                    ...
                    if int(like[i].contents[1].contents[5].contents[0]) == 0 or int(like[i].contents[3].contents[5].contents[0]) == 0:
                        db_rate = 1
                    else:
                        db_rate = int(like[i].contents[1].contents[5].contents[0]) / int(like[i].contents[3].contents[5].contents[0])
                    ...
                    if tmp == "":
                        try:
                            ...
                            continue
                    db_reple = tmp
                    sql = '''INSERT INTO MovieReple(movie_score, movie_like, movie_dislike, movie_rate, movie_reple) VALUES(%s,%s,%s,%s,%s)'''
